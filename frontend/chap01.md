...
注意，我们的课程中对后端更为侧重，后端会讲解的比较细致，但我们的假定是你已经掌握了前端的基础知识，所以我们的课程中不会过多地讲解前端的知识，而是会让你在实际的项目中去体会前端的知识，所以这个课程中的 Flutter 内容是有我个人倾向的，我会利用自己认为比较优秀的实践来讲解，但可能和其它教程中的实践有所不同，所以如果你觉得我讲解的 Flutter 内容不合适，你可以自行去学习其它教程中的 Flutter 内容。
